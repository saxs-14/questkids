  ...
  static const _circuits = [
    {
      'id': 'series_one_bulb',
      'description':
          'Complete the series circuit: drag the missing component to the gap.',
      'layout': '🔋 —?— 💡',
      'blanks': [
        {
          'position': 0,
          'correctComponent': 'wire',
          'emoji': '〰️',
          'hint': 'Connects components'
        },
      ],
    ...
    },
    {
      ...
      'blanks': [
        {
          'position': 0,
          'correctComponent': 'switch',
          'emoji': '🔘',
          'hint': 'Opens and closes the circuit'
        },
      ],
      'bank': ['wire', 'bulb', 'switch', 'resistor'],
      'labels': {
    ...
    },
    {
      ...
      'blanks': [
        {
          'position': 0,
          'correctComponent': 'battery',
          'emoji': '🔋',
          'hint': 'Provides electrical energy'
        },
      ],
      ...
      'blanks': [
        {
          ...
          'correctComponent': 'switch',
          'emoji': '🔘',
          'hint': 'Controls the flow'
        },
        {
          'position': 1,
          'correctComponent': 'wire',
          'emoji': '〰️',
          'hint': 'Connects the last bulb'
        },
      ],
      'bank': ['wire', 'bulb', 'switch', 'resistor'],
      'labels': {
      ...
      'blanks': [
        {
          ...
          'correctComponent': 'switch',
          'emoji': '🔘',
          'hint': 'Must be closed for current to flow'
        },
      ],
    ...
    },
    {
      ...
      'blanks': [
        {
          'position': 0,
          'correctComponent': 'buzzer',
          'emoji': '🔔',
          'hint': 'Makes a sound when current flows'
        },
      ],
    ...
    },
    {
      ...
      'blanks': [
        {
          'position': 0,
          'correctComponent': 'ammeter',
          'emoji': '🅰️',
          'hint': 'Measures current in series'
        },
      ],
    ...
    },
    {
      ...
      'blanks': [
        {
          'position': 0,
          'correctComponent': 'bulb',
          'emoji': '💡',
          'hint': 'In parallel, current splits'
        },
      ],
