...
class FirebaseConfig {
  ...
  // Google Sign-In
  static const String googleClientIdWeb = 'YOUR_GOOGLE_CLIENT_ID.apps.googleusercontent.com';
  static const String googleClientIdAndroid = 'YOUR_GOOGLE_CLIENT_ID.apps.googleusercontent.com';
  static const String googleClientIdIos = 'YOUR_GOOGLE_CLIENT_ID.apps.googleusercontent.com';
  
  // Play Games (Android)
  static const String playGamesAppId = 'YOUR_PLAY_GAMES_APP_ID';
  
  // Game Center (iOS)
  static const String gameCenterId = 'com.questkids.questkids'; // Update with your bundle ID
...
class EnvironmentConfig {
  ...
  static const bool enableFirebaseEmulators = false; // Set to true for local testing
}
...
class ErrorMessages {
  ...
  static const String phoneVerificationFailed = 'Phone verification failed. Please try again';
...
class SuccessMessages {
  static const String signUpSuccess = 'Account created successfully! Welcome to QuestKids!';
